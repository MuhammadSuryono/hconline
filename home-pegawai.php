  ...
  <div class="wrapper">
			...
			<ul class="sidebar-menu" style="margin-bottom: 60px;">
				...
				<li class="treeview"><a href="#"><i class="fa fa-book"></i> <span>Permohonan Cuti</span><i class="fa fa-angle-left pull-right"></i></a>
					<ul class="treeview-menu">
						<li><a href="home-pegawai.php?page=form-permohonan-cuti-tahunan">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-caret-right"></i> Cuti Tahunan</a></li>
						<!--<li><a href="home-pegawai.php?page=form-permohonan-cuti-umum">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-caret-right"></i> Cuti Umum</a></li>-->
            <li><a href="home-pegawai.php?page=form-permohonan-cuti-dispensasi">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-caret-right"></i> Cuti Dispensasi</a></li>
					</ul>
				</li>

        <li class="treeview"><a href="home-pegawai.php?page=form-izin"><i class="fa fa-book"></i> <span>Izin</span></i></a></li>
        <li class="treeview"><a href="home-pegawai.php?page=form-tugas-dinas"><i class="fa fa-book"></i> <span>Tugas</span></i></a></li>
        <li class="treeview"><a href="home-pegawai.php?page=attendance-baru-user"><i class="fa fa-book"></i> <span>Attendance</span></i></a></li>

        <li class="treeview"><a href="#"><i class="fa fa-book"></i> <span>History</span><i class="fa fa-angle-left pull-right"></i></a>
          <ul class="treeview-menu">
				     <li class="treeview"><a href="home-pegawai.php?page=history-cuti-pegawai"><i class="fa fa-exchange"></i> <span>History Cuti</span></a></li>
             <li class="treeview"><a href="home-pegawai.php?page=history-izin-pegawai"><i class="fa fa-exchange"></i> <span>History Izin</span></a></li>
             <li class="treeview"><a href="home-pegawai.php?page=history-lembur"><i class="fa fa-exchange"></i> <span>History Lembur</span></a></li>
          </ul>
        </li>
			</ul>
		</section>
	...
	<div class="content-wrapper">
		<section class="content">
              ...
              case 'form-permohonan-cuti-dispensasi': include "pages/transaksi/form-permohonan-cuti-dispensasi.php"; break;
              case 'permohonan-cuti-dispensasi': include "pages/transaksi/permohonan-cuti-dispensasi.php"; break;
              ...
              case 'form-izin': include "pages/transaksi/form-izin.php"; break;
              case 'izin': include "pages/transaksi/izin.php"; break;
