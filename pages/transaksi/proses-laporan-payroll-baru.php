    ...
    <table id="example2" class="table table-bordered table-striped">
        <thead>
            <tr style="background-color:salmon;">
                ...
                <th>Divisi</th>
                <th>Total mangkir</th>
                <th>Total menit terlambat (< 2 jam)</th> <th>Total Izin T. Masuk (STSD,UP)</th>
        ...
        <tbody>
            ...
            while ($du = mysql_fetch_array($daftaruser)) {
                ...
                echo "<td><center>" . $total_jam_kurang . "</center></td>";
                ...
                echo "</th>";
                echo "<td colspan='3' rowspan='5'></td>";
