			...
			<div class='row'>
				...
				<div class='col-xs-5'>
					<div class='box-body box-profile'>
						<a class='btn btn-primary btn-block' href='home-hrd.php?page=approved-izin-direksi&no=$no_cuti&nip=$nip&jml_hari=$jml_hari&jenis=$jenis'>Approved</a>
					</div>
				</div>
				<div class='col-xs-5'>
					<div class='box-body box-profile'>
						<a class='btn btn-warning btn-block' href='home-hrd.php?page=not-approved-izin-direksi&no=$no_cuti'>Not Approved</a>
					</div>
				</div>
				<div class='col-xs-1'></div>
			</div>
