            ...
            $absen .= "<tbody>";
                ...
                while ($row = mysql_fetch_array($user_query)) {
                    ...
                    for ($i=1; $i <= $jml_hari; $i++) { 
                        ...
                        if ($hari=='Sat' || $hari=='Sun') { // Sabtu / Minggu
                            ...
                            if ($kal == 1) {
                                ...
                                if ($izin1 == 1) { // Jika Form Izin ada
                                    ...
                                    $btn    = "onclick='showform(\"daterange_izin\", \"".$row['inisial_id']."\", \"".$ymd."\", \"".$izin_nonabsen[$row['inisial_id'].$ymd]['gambar']."\")'";
                                    ...
                                    if ($ada_cuti == 1) { // Jika Form Cuti Ada
                                        ...
                                        $btn        = "onclick='showform(\"daterange_cuti\", \"".$row['inisial_id']."\", \"".$ymd."\", \"".$cuti[$row['inisial_id'].$ymd]['gambar']."\")'";
                                    }
                                        ...
                                        if ($ada_unpaid == 1) { // Jika Form Cuti Ada
                                            ...
                                            $btn        = "onclick='showform(\"daterange_unpaid\", \"".$row['inisial_id']."\", \"".$ymd."\", \"".$unpaid[$row['inisial_id'].$ymd]['gambar']."\")'";
                        ...
                        $absen .= "<td ".$warna." ".$btn."><center>".$simbol.$jam."</center></td>";
                        $d++;
                    }
