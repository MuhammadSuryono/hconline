...
<?php
			...
			<div class='box box-primary'>
				<div class='register-box-body'>
					...
					<div class='row'>
						...
						<div class='col-xs-4'>
							<button type='button' onclick=location.href='home-pegawai2.php?page=form-permohonan-cuti-umum2' class='btn btn-block btn-warning'>Back</button>
						</div>
					</div>
				</div>
			</div>";
  ...
  {
    echo "<script> document.location.href='home-pegawai2.php'; </script>";
  }else{
    echo "GAGAL";
  }
