...
<div class="x_panel" style="">
    <div class="x_content">
        <div class="well" style="overflow: auto">
            ...
            ?>
            <form action="<?php echo $link; ?>?page=rekap-ranking" method="post">
                <div class="col-md-3">
                ...
                <div class="col-md-3" id="custom" style="display:none;">
                    <div class="input-prepend input-group">
                        <span class="add-on input-group-addon"><i class="glyphicon glyphicon-calendar fa fa-calendar"></i></span>
                ...
                <div class="col-md-4" id="checkah">
                  <label class="checkbox-inline"><input type="checkbox" value="STSD" name="jenis[]" id="jenis1">STSD</label>
                  <label class="checkbox-inline"><input type="checkbox" value="SDSD" name="jenis[]" id="jenis2">SDSD</label>
                  <label class="checkbox-inline"><input type="checkbox" value="Cuti" name="jenis[]" id="jenis3">Cuti</label>
                  <label class="checkbox-inline"><input type="checkbox" value="Mangkir" name="jenis" id="jenis4">Mangkir</label>
                </div>

                <div class="col-md-2">
                    <div class="input-prepend input-group">
                        <button type="submit" class="form-control btn btn-info"><i class="glyphicon glyphicon-eye fa fa-eye" id="test"></i> Tampilkan</button>
                    </div>
                </div>
            </form>
        </div>
...
<script>
    ...
    $( document ).ready(function() {
        ...
        $.ajax({
            url: "pages/transaksi/proses-rekap-ranking.php",
            dataType: 'json',
            method: 'post',
            data: {
