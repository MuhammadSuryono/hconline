...
<div class="wrapper">
	<header class="main-header">
		<a href="index.php" class="logo"><span class="logo-mini">MRI</span><span class="logo-lg"><b>HC</b> ONLINE</span></a>
				...
				<ul class="nav navbar-nav">
					<li class="dropdown user user-menu">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">
							...
							<span class="hidden-xs">HC Online</span>
						</a>
    ...
    <div class="row grid-divider">
	      ...
	      <div class="col-padding">
					<h4><i class="fa fa-handshake-o"></i><a href="http://180.211.92.132/rekrutmen/auth/registration">MRI Rekrutmen Online</h4>
					<h4><i class="fa fa-handshake-o"></i><a href="https://180.211.92.132/timesheetwfh/">MRI Timesheet WFH</h4>	
	      </div>
	    </div>
